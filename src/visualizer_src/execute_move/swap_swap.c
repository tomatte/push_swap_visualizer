...
/*   Updated: 2023/02/23 14:29:47 by dbrandao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_left_right_both(t_lst *node_a1, t_lst *node_a2, t_lst *node_b1, t_lst *node_b2, int length)
{
	...
	while (++i < length)
	{
		move_number(node_a1, 1, 'l', DEFAULT_DURATION / 2);
		move_number(node_a2, 1, 'r', DEFAULT_DURATION / 2);
		move_number(node_b1, 1, 'l', DEFAULT_DURATION / 2);
		move_number(node_b2, 1, 'r', DEFAULT_DURATION / 2);
	}
}
